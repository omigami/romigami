---
title: An R Markdown document converted from "notebook/spec2vec/tutorial.ipynb"
...
devtools::install_github("omigami/romigami", ref="MLOPS-306-ms2deepscore-refactor", force=TRUE)
...
```{r}
client <- omigami$Spec2Vec(token="73gyPBFLyA5zp1WYh0XzGBLMCiilJ3Gr")
```
