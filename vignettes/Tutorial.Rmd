---
title: An R Markdown document converted from "notebook/Tutorial.ipynb"
...
if("romigami" %in% installed.packages() == FALSE) {devtools::install_github("omigami/romigami")}
...
spectra_matches <- match_spectra_from_path(token = "my_token",
